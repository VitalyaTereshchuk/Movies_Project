...
//  Movies
//
//  Created by Vitaly on 08.01.2024.
//

import Foundation

struct Constants {
    static let apiKey = "" // TMBD_API_Key
...
class MoviesAPI {
    ...
    func getDiscoverMovies(completion: @escaping (Result<[Title], Error>) -> Void) {
        guard let url = URL(string: "\(Constants.baseUrl)/3/discover/movie?api_key=\(Constants.apiKey)&language=en-USasort_by=popularity-desc&include_adult=false&include_video=false&page=1&with watch_monetization_types=flatrate")
        else { return }
